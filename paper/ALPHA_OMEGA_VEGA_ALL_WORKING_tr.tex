...
\title{ALPHA OMEGA VEGA ALL WORKING: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, ALPHA OMEGA VEGA ALL WORKING'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
