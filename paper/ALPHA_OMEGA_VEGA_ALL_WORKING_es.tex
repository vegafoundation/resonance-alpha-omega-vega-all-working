...
\title{ALPHA OMEGA VEGA ALL WORKING: Un marco conceptual}
...
\begin{abstract}
Este trabajo introduce ALPHA OMEGA VEGA ALL WORKING como un nuevo marco conceptual dentro del paradigma de Resonance Data y QIRC.
