...
\title{ALPHA OMEGA VEGA ALL WORKING: Концептуальная основа}
...
\begin{abstract}
Данная работа представляет ALPHA OMEGA VEGA ALL WORKING как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
